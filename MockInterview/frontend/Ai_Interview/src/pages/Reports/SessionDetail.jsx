      ...
      <main className="mx-auto max-w-6xl px-4 py-6 space-y-5">
        ...
        <section className="rounded-2xl bg-white border border-gray-200 shadow-sm p-5">
          ...
          <div className="mt-3 text-xs text-gray-500">
            <span className="mr-2 px-2 py-0.5 rounded-md bg-gray-100 border">
              {session.kind}
            </span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="rounded-2xl bg-white border border-gray-200 shadow-sm p-5">
            ...
            <p className="text-sm text-gray-700">
              면접 합격 가능성{" "}
              <span className="font-semibold text-blue-600">32%</span> (초기
              준비 상태)
              <br />
              영상/음성의 전반적 개선이 필요합니다. 분석 리포트를 참고해
              개선하세요.
            </p>
            <div className="mt-3">
        ...
        <section className="rounded-2xl bg-white border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5">
            ...
            <div>
              ...
              {/* 🔁 여기 placeholder 박스를 차트로 교체 */}
              <div className="rounded-xl border border-gray-200 bg-white p-3">
                <InteractiveEmotionChart />
              </div>

              <p className="mt-2 text-[11px] text-gray-500">
                종합평: 시선 이탈 경계, 말끊김 다소 높음
              </p>
            </div>
            ...
            <div className="md:col-span-2 rounded-xl border border-amber-200 bg-amber-50 text-amber-800 p-4">
              ...
              <p className="text-sm">
                상체의 좌우 흔들림이 뚜렷합니다. 의자/카메라 위치를 재조정하고
                답변 전에 호흡을 정돈하세요.
              </p>
            </div>
          </div>
